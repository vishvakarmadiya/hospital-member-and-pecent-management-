...
def Member():  
    def login():
        ...
        if len(a1)>0:
            if a1.isdigit():
                ...
                with open('hospital_Member.csv','a',newline='') as ref:
    ...
    L0=Label(f1,text="Hospital member full details",font=("Calibri",50),fg="white" ,bg="#babdcc")
    L0.place(y=0,x=350)
    ...
    e1.place(y=10,x=153)
    L2=Label(f3,text="Member Name: ",font=("Calibri",15),fg="white" ,bg="#babdcc")
    L2.place(y=55,x=10)
    ...
    L6=Label(f3,text="Religion: ",font=("Calibri",15),fg="white" ,bg="#babdcc")
    L6.place(y=255,x=10)
    e6=Entry(f3,font=("Calibri",15),fg="#babdcc")
    e6.place(y=260,x=153)
    L7=Label(f3,text="Occupation:",font=("Calibri",15),fg="white" ,bg="#babdcc")
    L7.place(y=305,x=10)
    e7=Entry(f3,font=("Calibri",15),fg="#babdcc")
    e7.place(y=310,x=153)
    L8=Label(f3,text="Education: ",font=("Calibri",15),fg="white" ,bg="#babdcc")
    L8.place(y=355,x=10)
    e8=Entry(f3,font=("Calibri",15),fg="#babdcc")
    e8.place(y=360,x=153)
    L9=Label(f3,text="post: ",font=("Calibri",15),fg="white" ,bg="#babdcc")
    L9.place(y=405,x=10)
    e9=Entry(f3,font=("Calibri",15),fg="#babdcc")
    e9.place(y=410,x=153)
    L10=Label(f3,text="Email id: ",font=("Calibri",15),fg="white" ,bg="#babdcc")
    ...
    tv.heading("a",text="Religion")
    tv.heading("uf",text="Occupation")
    tv.heading("bn",text="Education")
    tv.heading("ed",text="post")
    tv.heading("oc",text="Email id")
    ...
    tv.column("#11",anchor=CENTER,width="80")
